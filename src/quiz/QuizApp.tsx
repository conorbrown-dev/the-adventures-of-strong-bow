...
export function QuizApp(): JSX.Element | null {
  ...
  return <main className={`quiz-app ${screen === "home" || screen === "games" ? "menu-app" : ""}`}><section className="quiz-shell">
    ...
    {screen === "home" && <div className="library-panel main-menu-panel"><p className="eyebrow">MOLLY'S LEARNING ACADEMY</p><h1>Choose an adventure</h1><p>Explore a lesson, practise Common Core skills, or play a learning game.</p><div className="library-grid main-menu-grid"><MenuCard title="Learning" description="Practice Common Core reading and math skills." color="purple" onClick={() => navigate("/learning")} /><MenuCard title="Lessons & Quizzes" description="Explore guided Math, Reading, and Language practice." color="cyan" onClick={openLessons} /><MenuCard title="Games" description="Choose a focused learning game to play." color="pink" onClick={() => { stopSpeaking(); navigate("/games"); }} /></div></div>}
