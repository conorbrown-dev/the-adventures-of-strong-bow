...
export class StudentsService {
  ...
  async updateSubjectLevel(studentId: string, dto: { subject: "ELA" | "MATH" | "SCIENCE" | "SOCIAL_STUDIES" | "HEALTH" | "PHYSICAL_EDUCATION" | "FINE_ARTS" | "COMPUTER_SCIENCE"; grade: string; verificationCode: string }) {
    await this.findStudent(studentId);
