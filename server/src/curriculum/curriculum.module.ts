...
@Module({ imports: [StudentsModule], controllers: [LearningController], providers: [PrismaStandardRepository, PrismaProgressRepository, { provide: CURRICULUM_PROCTOR_CODE, useFactory: () => process.env.CURRICULUM_PROCTOR_CODE }, LearningFacadeService], exports: [PrismaStandardRepository, PrismaProgressRepository] })
