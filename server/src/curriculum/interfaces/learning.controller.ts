...
export class LearningController {
  ...
  @Post("sessions") start(@Body() body: { learnerId: string; purpose: "practice" | "diagnostic" | "placement" | "proctored" | "adultScored"; proctorCode?: string; grade?: "K" | "1" | "2"; subject?: "ELA" | "MATH"; seed?: number }) { return this.learning.start(body.learnerId, body.purpose, body.seed, body.proctorCode, body.grade, body.subject); }
