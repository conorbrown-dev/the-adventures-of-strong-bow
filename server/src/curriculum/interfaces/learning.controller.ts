...
import { SubmitLearningAnswerDto } from "./submit-learning-answer.dto";
import { RequestLearningHintDto } from "./request-learning-hint.dto";
...
export class LearningController {
  ...
  @Post("sessions/:sessionId/answers") submit(@CurrentStudent() student: AuthenticatedStudent, @Param("sessionId") sessionId: string, @Body() body: SubmitLearningAnswerDto) { return this.learning.submitForLearner(sessionId, student.studentId, body.answer, body.usedHint === true); }
  @Post("sessions/:sessionId/activities/:instanceId/complete") completeActivity(@CurrentStudent() student: AuthenticatedStudent, @Param("sessionId") sessionId: string, @Param("instanceId") instanceId: string) { return this.learning.completeActivityForLearner(sessionId, student.studentId, instanceId); }
  @Post("sessions/:sessionId/activities/:instanceId/hints") hint(@CurrentStudent() student: AuthenticatedStudent, @Param("sessionId") sessionId: string, @Param("instanceId") instanceId: string, @Body() body: RequestLearningHintDto) { return this.learning.hintForLearner(sessionId, student.studentId, instanceId, body.level); }
  ...
  @Post("sessions/:sessionId/pause") pause(@CurrentStudent() student: AuthenticatedStudent, @Param("sessionId") sessionId: string) { return this.learning.pauseForLearner(sessionId, student.studentId); }
