...
export const kindergartenLanguageVariants: Record<string, KindergartenLanguageVariant[]> = {
  ...
  "K.L.2.d": [{ question: "Which word is spelled the right way?", answer: "sun", choices: ["sun", "sunn", "san"], explanation: "Sun uses the letters s, u, and n in that order." }],
  ...
  "K.L.5.a": [{ question: "Which two things are both vehicles?", answer: "bus and car", choices: ["bus and car", "bus and apple", "car and sock"], explanation: "A bus and car are both vehicles." }],
